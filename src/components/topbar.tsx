        ...
        <nav className="bg-white border-b border-[#F3E5AB]/50 px-4 py-2.5 sticky top-0 z-50 shadow-sm">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    ...
                    {/* Perfil de Usuario */}
                    <button className="flex items-center gap-2 p-1 pr-3 text-sm font-semibold text-[#996515] rounded-2xl hover:bg-[#D4AF37]/10 transition-colors border border-transparent hover:border-[#D4AF37]/30">
                    ...
                    {/* Menú Mobile */}
                    <button className="md:hidden p-2 text-[#D4AF37] hover:bg-[#D4AF37]/10 rounded-lg">
